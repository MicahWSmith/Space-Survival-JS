class Scene1 extends Phaser.Scene {
    ...
    preload(){
        // load all image assets to be used before playing scene
        ...
        this.load.audio("audio_beam", ["assets/sounds/gunshot.ogg", "assets/sounds/gunshot.ogg"]);
        this.load.audio("audio_pickup", ["assets/sounds/pickup.ogg", "assets/sounds/pickup.mp3"]);
        this.load.audio("audio_explosion", ["assets/sounds/explosion.ogg", "assets/sounds/explosion.mp3"]);
        this.load.audio("music", ["assets/sounds/power.ogg", "assets/sounds/power.mp3"]);
    }

    create(){
        // display loading text and switch scenes
